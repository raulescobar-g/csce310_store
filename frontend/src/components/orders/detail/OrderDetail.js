      ...
      <nav aria-label="breadcrumb" className="bg-custom-light rounded mb-4">
        <ol className="breadcrumb p-3">
          <li className="breadcrumb-item">
            <Link className="text-decoration-none link-secondary" to="/orders">
              All Orders
            </Link>
          </li>
      ...
      <div className="row mb-4">
        ...
        <div className="col-lg-5">
          <div className="d-flex flex-column h-100">
            ...
            <dd className="col-sm-8 mb-3">123</dd>

            <dt className="col-sm-4">Product ID</dt>
            <dd className="col-sm-8 mb-3">231</dd>

            <dt className="col-sm-4">User ID</dt>
            <dd className="col-sm-8 mb-3">234</dd>

            <dt className="col-sm-4">Payment ID</dt>
            <dd className="col-sm-8 mb-3">456</dd>
            ...
            <dl className="row">
              ...
              <dd className="col-sm-8 mb-3">Red</dd>
